// Dafny program rr2.dfy compiled into C#
...
public class @PCB__t {
  public BigInteger @pid = BigInteger.Zero;
  public BigInteger @duration = BigInteger.Zero;
  public BigInteger @ownerID = BigInteger.Zero;
  public BigInteger @usedCPU = BigInteger.Zero;
  public void @Init(BigInteger @a, BigInteger @b, BigInteger @c)
  {
  TAIL_CALL_START: ;
    var _this = this;
    var _obj0 = _this;
    ...
    var _rhs2 = @c;
    _obj0.@pid = _rhs0;
    _obj1.@duration = _rhs1;
    _obj2.@ownerID = _rhs2;
    (_this).@usedCPU = new BigInteger(0);
  }
...
public class @OS {
  public Dafny.Sequence<@PCB__t> @que = Dafny.Sequence<@PCB__t>.Empty;
  public BigInteger @quantum = BigInteger.Zero;
  public void @Init(BigInteger @a)
  {
  TAIL_CALL_START: ;
    var _this = this;
    (_this).@quantum = @a;
    (_this).@que = Dafny.Sequence<@PCB__t>.FromElements();
  }
  public void @enQueue(@PCB__t @a)
  {
  TAIL_CALL_START: ;
    var _this = this;
    (_this).@que = ((_this).@que).@Concat(Dafny.Sequence<@PCB__t>.FromElements(@a));
  }
  public void @deQueue(out @PCB__t @a)
  {
    @a = (@PCB__t)null;
  TAIL_CALL_START: ;
    var _this = this;
    @a = ((_this).@que).Select(new BigInteger(0));
    (_this).@que = ((_this).@que).Drop(new BigInteger(1));
  }
  public void @operate()
  {
  TAIL_CALL_START: ;
    ...
    { }
    { }
    @PCB__t @_215_pcb = (@PCB__t)null;
    @PCB__t _out0;
    (_this).@deQueue(out _out0);
    @_215_pcb = _out0;
    { }
    { }
    (@_215_pcb).@usedCPU = ((@_215_pcb).@usedCPU) + ((_this).@quantum);
    { }
    { }
    System.Console.Write(Dafny.Sequence<char>.FromString("pid: "));
    System.Console.Write((@_215_pcb).@pid);
    System.Console.Write(Dafny.Sequence<char>.FromString(" | duration: "));
    System.Console.Write((@_215_pcb).@duration);
    System.Console.Write(Dafny.Sequence<char>.FromString(" | usedCPU: "));
    System.Console.Write((@_215_pcb).@usedCPU);
    if (((@_215_pcb).@usedCPU) < ((@_215_pcb).@duration))
    {
      (_this).@enQueue(@_215_pcb);
      { }
      { }
      System.Console.Write(Dafny.Sequence<char>.FromString(" | wird eingereit \n"));
    }
    else
    {
      System.Console.Write(Dafny.Sequence<char>.FromString(" | wird nicht eingereit \n"));
    }
    { }
    @_215_pcb = (@PCB__t)null;
  }
}
...
public class @__default {
  ...
  {
  TAIL_CALL_START: ;
    @PCB__t @_216_pcb1 = (@PCB__t)null;
    var _nw0 = new @PCB__t();
    @_nw0.@Init(new BigInteger(1), new BigInteger(80), new BigInteger(5));
    @_216_pcb1 = _nw0;
    @PCB__t @_217_pcb2 = (@PCB__t)null;
    var _nw1 = new @PCB__t();
    @_nw1.@Init(new BigInteger(2), new BigInteger(20), new BigInteger(0));
    @_217_pcb2 = _nw1;
    @PCB__t @_218_pcb3 = (@PCB__t)null;
    var _nw2 = new @PCB__t();
    @_nw2.@Init(new BigInteger(3), new BigInteger(90), new BigInteger(0));
    @_218_pcb3 = _nw2;
    @PCB__t @_219_pcb4 = (@PCB__t)null;
    var _nw3 = new @PCB__t();
    @_nw3.@Init(new BigInteger(4), new BigInteger(50), new BigInteger(0));
    @_219_pcb4 = _nw3;
    @PCB__t @_220_pcb5 = (@PCB__t)null;
    var _nw4 = new @PCB__t();
    @_nw4.@Init(new BigInteger(5), new BigInteger(10), new BigInteger(0));
    @_220_pcb5 = _nw4;
    @PCB__t @_221_pcb6 = (@PCB__t)null;
    var _nw5 = new @PCB__t();
    @_nw5.@Init(new BigInteger(6), new BigInteger(75), new BigInteger(0));
    @_221_pcb6 = _nw5;
    { }
    { }
    { }
    ...
    @OS @_222_os = (@OS)null;
    var _nw6 = new @OS();
    @_nw6.@Init(new BigInteger(10));
    @_222_os = _nw6;
    { }
    { }
    { }
    { }
    (@_222_os).@enQueue(@_216_pcb1);
    (@_222_os).@enQueue(@_217_pcb2);
    { }
    { }
    { }
    (@_222_os).@enQueue(@_218_pcb3);
    (@_222_os).@enQueue(@_219_pcb4);
    (@_222_os).@enQueue(@_220_pcb5);
    (@_222_os).@enQueue(@_221_pcb6);
    BigInteger @_223_i = BigInteger.Zero;
    @_223_i = new BigInteger(0);
    while (((@_223_i) < (new BigInteger(34))) && ((new BigInteger(((@_222_os).@que).Length)) > (new BigInteger(0))))
    {
      (@_222_os).@operate();
